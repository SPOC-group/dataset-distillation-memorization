...
if __name__ == "__main__":
    ...
    for _ in range(5):
        ...
        for num_samples_per_class in [250]:
            ...
            for student_hidden_dim in [100, 200, 250, 300, 400, 500, 600, 750, 1000, 2000]:
                for train_frac in np.linspace(0.05, 0.95, 10):
                    for temperature in [20.0]:
                        student_config = StudentConfig(train_frac=train_frac, temperature=temperature,  model_name='one_layer_network',hidden_dim=student_hidden_dim,num_epochs=10000)
