    ...
    for _ in range(5):
        for h in [100,250,350,650]:
            ...
            for num_samples_per_class in [50, 125, 250, 375, 500, 625, 750, 875, 1000, 1125, 1250, 1375, 1500, 1625, 1750, 1875, 2000, 2125, 2250, 2375, 2500]:
                ...
                teacher_config = TeacherConfig(model_name='one_layer_network',hidden_dim=h,num_epochs=2000)
                ...
                for train_frac in [0.45]:
                    for temperature in [20.0]:
                        student_config = StudentConfig(train_frac=train_frac, temperature=temperature,  model_name='one_layer_network',hidden_dim=h,num_epochs=10000)
